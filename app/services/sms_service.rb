class SmsService
  ...
  def call
    @client.messages.create(
      ...
      body: "Hello, #{@teacher.full_name}.\n\n#{@school.school_name} at #{@school.address} has an opening to teach #{@request.format_grade} on #{@request.format_date}.\nPlease respond yes to this text if you are available."
    )
  end
end
